...
*/
//https://github.com/nutanpal/assessment--2
...
function canWeDeliverTwo(zipCode) {
  var arrayLength = deliveryAreaZipCodes.length;
  var isFound = false;
  for (var i = 0; i < arrayLength; i++) {
    if (zipCode == deliveryAreaZipCodes[i]) isFound = true;
  }
...
newDesc = deals[1].desc.replace("March! ", "April!").replace("   ", "").trim();
//trim() further removes the whitespace around. can use either replace" " or trim
